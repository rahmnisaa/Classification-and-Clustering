...
- `Dataset_clustering.csv`  
  Dataset used for the clustering task.

- `[Klasifikasi] Submission Akhir BMLP_Rahma Nur Annisa.ipynb`  
  Jupyter Notebook containing the full process and results of the classification project.
